                                    ...
                                    <asp:Repeater ID="Repeater1" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%#Eval("charge") %></td>
                                                <td>
                                                    <a class="label label-danger" href="chechout.aspx?id=<%#Eval(" id")
                                                    %>&customerid=<%#Eval("customerid") %>">退房</a>
                                    ...
                                    <asp:Repeater ID="Repeater3" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td><%#Eval("charge") %></td>
                                                <td>
                                                    <a class="label label-success" href="stayin.aspx?id=<%#Eval(" id")
                                                    %>">入住</a>
