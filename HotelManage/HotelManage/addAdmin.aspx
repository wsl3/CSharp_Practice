<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addAdmin.aspx.cs" Inherits="HotelManage.addAdmin" %>
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="input_name" placeholder="请输入管理员用户名！"
                                           name="username">
                                </div>
                                <div class="form-group">
                                    <label for="input_name">密码</label>
                                    <input type="text" class="form-control" id="input_name" placeholder="请输入管理员密码！"
                                           name="password">
                                </div>
                                
                            </div>
                            <div class="box-footer">
                                <asp:Button ID="Button1" runat="server" Text="Button" class="btn btn-primary" type="submit" OnClick="Button1_Click"/>
