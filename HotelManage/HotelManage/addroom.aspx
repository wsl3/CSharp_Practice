<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addroom.aspx.cs" Inherits="HotelManage.addroom" %>
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">添加客房</h3>
                            </div>

                            <div class="box-body">
                                <div class="form-group">
                                    <label for="input_name">客房类型</label>
                                    <input type="text" class="form-control" id="input_name" placeholder="请输入客房类型！"
                                           name="roomtype">
                                </div>
                                <div class="form-group">
                                    <label for="input_name">客房简介</label>
                                    <input type="text" class="form-control" id="input_name" placeholder="请输入客房简介！"
                                           name="info">
                                </div>
                                <div class="form-group">
                                    <label for="input_name">客房收费</label>
                                    <input type="text" class="form-control" id="input_name" placeholder="请输入客房收费！"
                                           name="charge">
                                </div>
                            </div>
                            <div class="box-footer">

                                <asp:Button ID="Button2" runat="server" Text="添加" OnClick="Button2_Click" class="btn btn-primary" type="submit"/>
